      ...
      <nav className={`sticky top-0 z-50 transition-all duration-300 ${isScrolled ? "bg-white/95 backdrop-blur-md shadow-md h-16" : "bg-white h-20"} border-b border-neutral-200`}>
        <div className="w-full px-6 md:px-10 flex items-center justify-between h-full">
          ...
          <ul className="hidden md:flex items-center gap-8">
            ...
            <li>
              <motion.a 
                href={getWhatsAppLink("Hello! I'm interested in getting started with Arise Research Blueprint Lab. Can you help me choose the right plan?")} 
                target="_blank" 
          ...
          {mobileMenuOpen && (
            ...
            >
              <ul className="flex flex-col items-center gap-4">
                ...
                <li>
                  <a href={getWhatsAppLink("Hello! I'm interested in getting started with Arise Research Blueprint Lab.")} target="_blank" className="btn btn-secondary w-full">
                    Get Started
                  </a>
                </li>
              </ul>
        ...
        <div className="container grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <motion.a 
                href={getWhatsAppLink("Hello! I'm interested in Arise Research Blueprint Lab and would like to connect with your team.")} 
                target="_blank" 
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
          ...
          <div className="max-w-5xl mx-auto bg-white rounded-[2rem] overflow-hidden shadow-2xl border border-neutral-100 flex flex-col md:flex-row">
            ...
            <div className="md:w-2/3 p-12">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 p-6 bg-blue-50 rounded-2xl border border-blue-100">
                ...
                <motion.a 
                  href={getWhatsAppLink("Hello! I'm interested in the Enterprise Exclusive 'While You Sleep' Automation Pipeline. Can we schedule a feasibility call?")} 
                  target="_blank" 
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
            ...
            <div>
              ...
              <ul className="space-y-4 text-neutral-400">
                <li className="flex flex-col gap-1">
                  ...
                  <a 
                    href={getWhatsAppLink("Hello Annet! I'm contacting you through the Arise Research Blueprint Lab website. I'd like to inquire about your services.")} 
                    target="_blank" 
                    className="flex items-center gap-3 hover:text-white transition-colors"
                  >
                    <MessageCircle size={16} className="text-accent-orange" /> +250 798 600 238
                  </a>
                </li>
                <li className="flex items-center gap-3">
                  <a 
                    href={`https://wa.me/250795590127?text=${encodeURIComponent("Hello! I'm contacting the Arise Office regarding your AI Blueprint services.")}`} 
                    target="_blank" 
                    className="flex items-center gap-3 hover:text-white transition-colors"
                  >
                    <MessageCircle size={16} className="text-accent-orange" /> +250 795 590 127 (Office)
                  </a>
                </li>
